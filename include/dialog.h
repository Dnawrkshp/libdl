...
enum DialogIds
{
    ...
    DIALOG_ID_REACTOR_THIS_IS_MY_HOUSE = 0x2AE3,
    DIALOG_ID_REACTOR_IM_GONNA_PUT_YOU_IN_A_WORLD_OF_HURT = 0x2AE4,
    DIALOG_ID_REACTOR_IM_GONNA_SMACK_THAT_STUPID_LOOK_OFF_YOUR_FACE = 0x2AE5,
    DIALOG_ID_REACTOR_COME_ON_THATS_ALL_YOU_GOT = 0x2AE6,
    DIALOG_ID_REACTOR_HERO_HAH_HERO_MY_TIN_BUTT = 0x2AE7,
    DIALOG_ID_REACTOR_WHEN_IM_DONE_WITH_YOU_YOU_GONNA_LOOK_LIKE_ROADKILL = 0x2AE8,
    DIALOG_ID_REACTOR_TADAOW_HOW_YOU_LIKE_ME_NOW = 0x2AE9,
    DIALOG_ID_REACTOR_BOOYAH = 0x2AEA,
    DIALOG_ID_REACTOR_DODGE_THIS = 0x2AEB,
    DIALOG_ID_REACTOR_AFTER_THIS_YOU_GONNA_FEEL_DEAD_TIRED = 0x2AEC,
    DIALOG_ID_REACTOR_AH_THAT_AINT_FUNNY = 0x2AED,
    DIALOG_ID_REACTOR_OOH_IM_GONNA_NEED_TO_SIT_FOR_A_SEC = 0x2AEE,
    DIALOG_ID_REACTOR_OOOH_OKAY_PLAY_TIMES_OVER_RAT_BOY_TIME_TO_DIE = 0x2AEF,
    DIALOG_ID_REACTOR_AW_DAMN_NOW_YOU_GOT_ON_MY_BAD_SIDE = 0x2AF0,
    // SHELLSHOCK:  0x2AF1 - 0x2AFE
    // VOX:         0x2AFF - 0x2B43
    DIALOG_ID_VOX_ITS_BOMB_TIME = 0x2B19,
    DIALOG_ID_VOX_JACKPOT = 0x2B3E,
    DIALOG_ID_VOX_YOU_GOT_A_PRIZE_TIME_TO_COLLECT = 0x2B3F,
    // AL:          0x
    // CLANK:       0x2B6F - 0x2B81
